...
![LunoDB](https://img.shields.io/badge/version-1.25.2-blue.svg)
...
**✨ NEW in v1.25.2:** Smoother table editing with logged changes and loading indicators, faster pagination, and MySQL reliability fixes.
