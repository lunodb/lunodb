...
![LunoDB](https://img.shields.io/badge/version-1.24.2-blue.svg)
...
**✨ NEW in v1.24.2:** Fix for editing filtered query results and smoother performance when selecting and scrolling through large result sets.
