...
![LunoDB](https://img.shields.io/badge/version-1.19.3-blue.svg)
...
**✨ NEW in v1.19.3:** Faster queries with smarter SQL parsing. Import success messages now show file sizes. Database connections lock during import/export operations to prevent accidental switches. Smart date handling displays dates and datetimes with appropriate formatting.
