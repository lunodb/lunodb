...
![LunoDB](https://img.shields.io/badge/version-1.28.1-blue.svg)
...
**✨ NEW in v1.28.1:** Table tabs paint their rows instantly after reconnecting — no more long loading spinners on the first tab.
